 ...
 * `overlay:name` creates an independent scale, hidden by default and shared only
 * by series using that same name on this pane. Chart.setPriceAxisPlacement can
