...
export default defineConfig({
  ...
  projects: [
    ...
    ...(['chromium', 'firefox', 'webkit'] as const).map(browserName => ({
      ...
      testMatch: /yfinance-(?:ui-253|mobile|templates|indicator-source)\.spec\.ts/,
