...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'chromium', use: { ...devices['Desktop Chrome'] }, testIgnore: /(?:yfinance(?:-(?:ui-253|mobile|templates|indicator-source|grid))?|widget-grid|widget-ui-253|widget-data-loading|widget-localization|widget-alerts|chart-data-export|instruments|indicator-source-markers|alert-line-drag|table-layout)\.spec\.ts/ },
    ...
    ...(['chromium', 'firefox', 'webkit'] as const).map(browserName => ({
      ...
      testMatch: /yfinance-(?:ui-253|mobile|templates|indicator-source|grid)\.spec\.ts/,
